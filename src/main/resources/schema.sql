...
CREATE TABLE IF NOT EXISTS shopping_application.lists (
...
CREATE TABLE IF NOT EXISTS shopping_application.items (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS shopping_application.notes (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
